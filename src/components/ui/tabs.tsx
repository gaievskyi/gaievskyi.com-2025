  ...
  return (
    <TabsPrimitive.List
      ...
      className={cn(
        ...
        variant === "default"
          ? "p-0.5 corner-squircle-md bg-muted text-muted-foreground/64"
      ...
      <TabsPrimitive.Indicator
        ...
        className={cn(
          ...
          variant === "underline"
            ...
            : "-z-1 corner-squircle-md bg-background shadow-sm",
        )}
      />
    </TabsPrimitive.List>
  )
